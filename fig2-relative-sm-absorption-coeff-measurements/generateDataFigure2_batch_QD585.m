...
savefig(fig,fullfile(directory_out,'estimatedExcitationSpectra_lightMode.fig'))
exportgraphics(fig,fullfile(directory_out,'estimatedExcitationSpectra_lightMode.png'),'Resolution',400)
set(gcf,'renderer','Painters')
exportgraphics(fig,fullfile(directory_out,'estimatedExcitationSpectra_lightMode.eps'))


%% Generate a dark mode figure
