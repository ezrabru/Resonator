...
clear all
load('D:\manuscripts\resonator\figures\figure2\quantitative resonator\data QD655\analysis results\workspace.mat');
outputdirfig = 'D:\manuscripts\resonator\figures\figure2\quantitative resonator\data QD655\analysis results';
...
pathBulkSpectrum = 'D:\manuscripts\resonator\figures\figure2\quantitative resonator\data spectra\dyes\Qdot655';
...
fig = figure;
subplot(1,4,1); bar([1 2],[iqr(ensembleStdRatio405(:)) iqr(singleStdRatio405(:))])
subplot(1,4,2); bar([1 2],[iqr(ensembleStdRatio488(:)) iqr(singleStdRatio488(:))])
subplot(1,4,3); bar([1 2],[iqr(ensembleStdRatio561(:)) iqr(singleStdRatio561(:))])
subplot(1,4,4); bar([1 2],[iqr(ensembleStdRatio638(:)) iqr(singleStdRatio638(:))])
